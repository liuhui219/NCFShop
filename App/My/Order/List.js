    ...
    datas.orderItemList.forEach((info,i)=>{
      if(info.hasOwnProperty('price') && flog == true){
        ...
        if(datas.orderItemList.length-1 == i){
          ...
          sunTotal=sunTotal.toFixed(2) + '元';

        }

      }else{
        sunTotal='待报价',flog = false;
      }
    })
    return sunTotal
  }
        ...
        return (
             <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                 <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                    <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:16}}>{data.businessInfo.businessName}</Text></View>
                    <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:16}}>待确认</Text></View>
                 </View>
                 <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,Issure)} style={{flex:1}}>
                 <View style={{flex:1,}}>
                 ...
                 <View style={{flexDirection:'row',flex:1,justifyContent:'flex-end',height:50,alignItems:'center',borderTopWidth:1,borderColor:'#eee',paddingRight:10}}>
                     ...
                     <View style={{marginLeft:15,flexDirection:'row'}}>
                        ...
                        <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:16,color:'#FF3E3F',}}>{this.Total(data)}</Text>
                     </View>
                 </View>
                 <View style={{flexDirection:'row',flex:1,justifyContent:'flex-end',height:50,alignItems:'center',borderTopWidth:1,borderColor:'#eee',paddingRight:10,paddingTop:10}}>

                    <TouchableOpacity activeOpacity={1} onPress={this.close.bind(this,data.order.orderNumber)}>
                       <View style={{width:90,height:35,borderWidth:1,borderColor:'#ddd',justifyContent:'center',alignItems:'center',marginLeft:15,borderRadius:20}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,color:'#777',}}>关闭交易</Text></View>
                    </TouchableOpacity>
                 </View>
             </View>
    			)
        ...
        return (
                   <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                       <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                          ...
                          <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:WID==320 ? 14 : 16}}>待付款</Text></View>
                       </View>
                       <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,waitPay)} style={{flex:1}}>
                       <View style={{flex:1,}}>
                       {data.orderItemList.map((infos,k)=>{
                         if(infos.hasOwnProperty('price')){
                           return <View key={k} style={{flex:1,flexDirection:'row',alignItems:'center',paddingTop:15,paddingBottom:15,}}>
                       ...
                       <View style={{flexDirection:'row',flex:1,justifyContent:'flex-end',height:50,alignItems:'center',borderTopWidth:1,borderColor:'#eee',paddingRight:10,paddingTop:10}}>
                           <TouchableOpacity activeOpacity={1} onPress={this.close.bind(this,data.order.orderNumber)}>
                              <View style={{width:WID==320 ? 80 : 90,height:35,borderWidth:1,borderColor:'#ddd',justifyContent:'center',alignItems:'center',borderRadius:20}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:WID==320 ? 12 : 14,color:'#777',}}>关闭交易</Text></View>
                           </TouchableOpacity>
                          <TouchableOpacity activeOpacity={1} onPress={this.pay.bind(this,data.businessInfo,data.order.orderNumber)}>
                              <View style={{width:WID==320 ? 90 : 100,height:35,borderWidth:1,borderColor:'#ddd',justifyContent:'center',alignItems:'center',marginLeft:10,borderRadius:20}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:WID==320 ? 12 : 14,color:'#777',}}>支付说明</Text></View>
                          </TouchableOpacity>
                          <TouchableOpacity activeOpacity={1} onPress={this.updatePay.bind(this,data.order.orderNumber)}>
                             <View style={{width:WID==320 ? 90 : 100,height:35,borderWidth:1,borderColor:'#ddd',justifyContent:'center',alignItems:'center',marginLeft:10,borderRadius:20}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:WID==320 ? 12 : 14,color:'#777',}}>上传付款凭证</Text></View>
                          </TouchableOpacity>
           ...
           return (
                <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                    <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                       <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:WID==320 ? 14 : 16}}>{data.businessInfo.businessName}</Text></View>
                       <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:WID==320 ? 14 : 16}}>待发货</Text></View>
                    </View>
                    <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,waitSent)} style={{flex:1}}>
                    <View style={{flex:1,}}>
                    {data.orderItemList.map((infos,k)=>{
                      if(infos.hasOwnProperty('price')){
                        return <View key={k} style={{flex:1,flexDirection:'row',alignItems:'center',paddingTop:15,paddingBottom:15,}}>
           ...
           return (
                      <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0,overflow:'hidden'}}>
                          <View style={{flex:1,flexDirection:'row',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                             <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:WID==320 ? 14 : 16}}>{data.businessInfo.businessName}</Text></View>
                          </View>
                          <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,Complete)} style={{flex:1}}>
                          <View style={{flex:1,}}>
                          {data.orderItemList.map((infos,k)=>{
                            if(infos.hasOwnProperty('price')){
                              return <View key={k} style={{flex:1,flexDirection:'row',alignItems:'center',paddingTop:15,paddingBottom:15,}}>
                          ...
                          <View style={{position:'absolute',top:-15,right:20}}><Image resizeMode={'contain'} style={{ width:70, height:70, }} source={require('../../img/over.png')} /></View>
                      </View>
                  )
               ...
               return (
                          <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                              <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                                 <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:16}}>{data.businessInfo.businessName}</Text></View>
                                 <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:16}}>买家取消订单</Text></View>
                              </View>
                              <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,closeInfo)} style={{flex:1}}>
                              <View style={{flex:1,}}>
                              {data.orderItemList.map((infos,k)=>{
                              ...
                              <View style={{flexDirection:'row',flex:1,justifyContent:'flex-end',height:50,alignItems:'center',borderTopWidth:1,borderColor:'#eee',paddingRight:10}}>
                                  ...
                                  <View style={{marginLeft:15,flexDirection:'row'}}>
                                     <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,color:'#777',}}>总金额(含运费)：</Text>
                                     {data.order.totalPrice ? <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:16,color:'#FF3E3F',}}>{data.order.totalPrice}元</Text> : <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:16,color:'#FF3E3F',}}>{this.Total(data)}</Text>}
                                  </View>
                              </View>
               ...
               return (
                    <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                        <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                           <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:WID==320 ? 14 : 16}}>{data.businessInfo.businessName}</Text></View>
                           <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:WID==320 ? 14 : 16}}>待收货</Text></View>
                        </View>
                        <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,waitReceipt)} style={{flex:1}}>
                        <View style={{flex:1,}}>
                        {data.orderItemList.map((infos,k)=>{
                          if(infos.hasOwnProperty('price')){
                            return <View key={k} style={{flex:1,flexDirection:'row',alignItems:'center',paddingTop:15,paddingBottom:15,}}>
                        ...
                        <View style={{flexDirection:'row',flex:1,justifyContent:'flex-end',height:50,alignItems:'center',borderTopWidth:1,borderColor:'#eee',paddingRight:10,paddingTop:10}}>
                           ...
                           <TouchableOpacity activeOpacity={1} onPress={this.YES.bind(this,data.order.orderNumber)}>
                              <View style={{width:90,height:35,borderWidth:1,borderColor:'#ddd',justifyContent:'center',alignItems:'center',marginLeft:15,borderRadius:20}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:14,color:'#777',}}>确认收货</Text></View>
                           </TouchableOpacity>
                        </View>
                    </View>
                 )
               ...
               return (
                    <View style={{width:Dimensions.get('window').width,backgroundColor:'#fff',marginBottom:15,padding:15,paddingTop:0}}>
                        <View style={{flex:1,flexDirection:'row',justifyContent:'space-between',alignItems:'center',height:55,borderBottomWidth:1,borderColor:'#eee'}}>
                           <View style={{flex:1,height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#333',fontSize:WID==320 ? 14 : 16}}>{data.businessInfo.businessName}</Text></View>
                           <View style={{height:55,flexDirection:'row',alignItems:'center',}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#999',fontSize:WID==320 ? 14 : 16}}>已付款待发货</Text></View>
                        </View>
                        <TouchableHighlight underlayColor="transparent" onPress={this.proinfo.bind(this,data.order.orderNumber,waitSure)} style={{flex:1}}>
                        <View style={{flex:1,}}>
                        {data.orderItemList.map((infos,k)=>{
                          if(infos.hasOwnProperty('price')){
                            return <View key={k} style={{flex:1,flexDirection:'row',alignItems:'center',paddingTop:15,paddingBottom:15,}}>
