...
const CustomChildren = props => (
    ...
    <View style={{width:Dimensions.get('window').width,flexDirection:'row',height:45}}>
      <View style={{width:100,justifyContent:'center',alignItems:'center',}}>
         <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:15,}}>所在地区：</Text>
      </View>
      <TouchableOpacity
      ...
      <View  style={{ flexDirection:'row',justifyContent:'space-between',alignItems:'center',flex:1,paddingRight:10}}>
        ...
        <Ionicons name="ios-arrow-forward-outline" color="#666" size={24}  />
      </View>
      </TouchableOpacity>
    </View>
      ...
      <View style={Styles.container}>
          <View style={Styles.card}>
            ...
            <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'white',fontSize:18}}>新建收货地址</Text>
            </View>
            ...
            <ScrollView style={{flex:1}}>
              <View style={{flex:1,flexDirection:'row',paddingTop:10,paddingBottom:10,borderBottomWidth:1,borderColor:'#eee'}}>
                <View style={{width:100,justifyContent:'center',alignItems:'flex-start',paddingLeft:15}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:15,}}>收货人：</Text>
                </View>
                <View style={{flex:1,}}>
                    <TextInput
                      ref='name'
              ...
              <View style={{flex:1,flexDirection:'row',paddingTop:10,paddingBottom:10,borderBottomWidth:1,borderColor:'#eee'}}>
                <View style={{width:100,justifyContent:'center',alignItems:'center',}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:15,}}>联系电话：</Text>
                </View>
                <View style={{flex:1,}}>
                    <TextInput
                      ref='phone'
              ...
              <View style={{flex:1,flexDirection:'row',paddingTop:10,paddingBottom:10,borderBottomWidth:1,borderColor:'#eee'}}>
                <View style={{width:100,justifyContent:'center',alignItems:'center',}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:15,}}>详细地址：</Text>
                </View>
                <View style={{flex:1,}}>
                    <TextInput
                      ref='addressInfo'
                  ...
                  <TouchableOpacity activeOpacity={1} onPress={this.CheckBox.bind(this)}>
                      <View style={{flexDirection:'row',alignItems:'center'}}>
                         <View style={{width:50,justifyContent:'center',alignItems:'center'}}>
                            {this.state.ischeck ? <Ionicons name="ios-checkmark-circle" size={30} color="#036EB8" /> : <Ionicons name="ios-radio-button-off" size={30} color="#999" />}
                         </View>
                         <View><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:15,}}>设为默认地址</Text></View>
                      </View>
                  </TouchableOpacity>
          ...
          <TouchableOpacity onPress={this.submit.bind(this)} activeOpacity={1}>
            <View style={{width: Dimensions.get('window').width,height:50,justifyContent:'center',alignItems:'center',backgroundColor:'#046EB8'}}>
               <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'white',fontSize:20}}>保存</Text>
            </View>
          </TouchableOpacity>
      </View>
    );
