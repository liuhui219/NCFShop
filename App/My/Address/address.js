      ...
      <View style={Styles.container}>
          ...
          <KeyboardAvoidingView behavior='padding' style={{flex:1}}>
            <ScrollView style={{flex:1}}>
              ...
              <View style={{flex:1,flexDirection:'row',paddingTop:10,paddingBottom:10,borderBottomWidth:1,borderColor:'#eee',height:55}}>
                <View style={{width:100,justifyContent:'center',alignItems:'center',}}>
                ...
                <View style={{flex:1,}}>
                    <TextInput
                      ...
                      placeholder='请输入详细地址'
                      placeholderTextColor='#CAD1DA'
                      style={{height: 50,flex:1,color:'#000',  borderWidth: 1,padding: 0,borderColor:"transparent",fontSize:14}}
