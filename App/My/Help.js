...
export default class MyComponent extends Component {
  ...
  getData(){
    ...
    fetch('https://yzx.shixiweiyuan.com/app/getAppDoc?type=1')
      ...
      <View style={Styles.container}>
          <View style={Styles.card}>
            ...
            <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'white',fontSize:WID==320 ? 16 : 18}}>帮助中心</Text>
            </View>
