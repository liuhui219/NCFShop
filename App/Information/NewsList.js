...
export default class MyComponent extends Component {
  ...
  getData(){
    var that = this;
    fetch('https://yzx.shixiweiyuan.com/app/article/show', {
        method: 'POST',
        headers: {
        ...
        return (
              <TouchableHighlight underlayColor="transparent" onPress={this.newsInfo.bind(this,data.id)}>
                <View style={{padding:15,borderBottomWidth:1,borderColor:'#eee'}}>
                   <View>
                      <Text allowFontScaling={false} adjustsFontSizeToFit={false} numberOfLines={2} style={{fontSize:14,color:'#000',lineHeight:19}}>{data.title}</Text>
                   </View>
                   ...
                   <View style={{marginTop:10,flexDirection:'row',justifyContent:'space-between',alignItems:'center'}}>
                      <View style={{flex:1}}><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:12,color:'#777'}}>{data.source}</Text></View>
                      <View><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{fontSize:12,color:'#777'}}>{moment(data.createTime).format("YYYY-MM-DD")}</Text></View>
                   </View>
                </View>
              </TouchableHighlight>
    			)
                  ...
                  <View style={{padding:15,borderBottomWidth:1,borderColor:'#eee'}}>
                      <View style={{flexDirection:'row'}}>
                        ...
                        <View style={{flex:1,justifyContent:'space-between'}}>
                           <View><Text allowFontScaling={false} adjustsFontSizeToFit={false} numberOfLines={2} style={{fontSize:14,color:'#000',lineHeight:19}}>{data.title}</Text></View>
  ...
  _onEndReach(){
    if(!this.state.isReach){
        ...
        var that=this
        fetch('https://yzx.shixiweiyuan.com/app/article/showNews', {
            method: 'POST',
            headers: {
            'Content-Type': 'application/x-www-form-urlencoded',
            },
