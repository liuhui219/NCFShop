...
export default class NCFShop extends Component {
  ...
  constructor(props) {
     super(props);
         ...
         PhoneFont:new Animated.Value(16),
         PassText:new Animated.Value(12),
         PassFont:new Animated.Value(16),
         logins:'登录',
         Islogins:false,
 	     };
     }
      ...
      <StatusBar
       ...
       />
        ...
        <View style={{flex:1,backgroundColor:'transparent'}}>
          <View style={{ width: Dimensions.get('window').width,justifyContent:'center',alignItems:'center',height:220,}}>
             <Image resizeMode={'contain'} style={{ width: 100,}} source={require('../img/login_Logo.png')} />
          </View>
          ...
          {!this.state.IsShowSubmit ? <TouchableHighlight  style={{justifyContent:'center',backgroundColor:'#dadada',alignItems:'center',marginTop:30,width:Dimensions.get('window').width-50,marginLeft:25,borderRadius:30}}>
              <View style={{width:Dimensions.get('window').width-40,justifyContent:'center',alignItems:'center',borderRadius:20,height:50,}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#aaa',fontSize:18}}>登录</Text>
              </View>
              ...
              <View style={{width:Dimensions.get('window').width-40,justifyContent:'center',alignItems:'center',borderRadius:20,height:50,}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#fff',fontSize:18}}>{this.state.logins}</Text>
          ...
          <TouchableHighlight onPress={this.GoReg.bind(this)} underlayColor="rgba(231, 224, 224, 0.9)" style={{justifyContent:'center',borderRadius:2,alignItems:'center',marginTop:30,width:Dimensions.get('window').width-50,marginLeft:25,borderRadius:30,borderWidth:1,borderColor:'#d4dce1'}}>
              <View style={{width:Dimensions.get('window').width-40,justifyContent:'center',alignItems:'center',borderRadius:20,height:50,}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#758692',fontSize:18}}>新用户注册</Text>
              </View>
          </TouchableHighlight>

          <View style={{width:Dimensions.get('window').width-40,marginLeft:20,flexDirection:'row',alignItems:'center',justifyContent:'center',flex:1}}>
              <TouchableOpacity onPress={this.GoForget.bind(this)} style={{justifyContent:'center',alignItems:'center',}}>
                <View style={{justifyContent:'center',alignItems:'center',}}>
                   <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#758692',fontSize:14}}>忘记密码?</Text>
                </View>
              </TouchableOpacity>
          </View>
        </View>
        <TouchableOpacity activeOpacity={1} onPress={this.close.bind(this)} style={{position:'absolute',top:(DeviceInfo.getModel() == 'iPhone X' || DeviceInfo.getModel() == 'Simulator') ? 40 : 30,left:30}}>
        <View >
           <Ionicons name="md-close" color="#666" size={30}  />
        </View>
        </TouchableOpacity>
