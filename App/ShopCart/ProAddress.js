...
import address from '../My/Address/address';
import EditAddress from '../My/Address/EditAddress';
    ...
    fetch('https://yzx.shixiweiyuan.com/user/address/list', {
      ...
      .then(function (result) {
       ...
       if(result.code == 0){
         ...
         Toast.showShortCenter(result.messag)
         that.setState({
           loaded:false,
           reload:true
         })
      ...
      <View style={Styles.container}>
          <View style={Styles.card}>
            ...
            <View style={{flex:1,alignItems:'center',justifyContent:'center'}}>
                <Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'white',fontSize:WID==320 ? 16 : 18}}>收货地址</Text>
            </View>
             ...
             {this.state.addressData.length == 0 ? <View style={{flex:1,justifyContent:'center',alignItems:'center'}}>
                 ...
                 {this.state.addressData.map((info,i)=>{
                   return <View key={i} style={{marginBottom:15,backgroundColor:'#fff'}}>
                      <TouchableOpacity activeOpacity={1} onPress={this.select.bind(this,info)}>
                        <View>
                      ...
                      <View style={{flex:1,flexDirection:'row',paddingTop:10,paddingBottom:10}}>
                          <TouchableOpacity activeOpacity={1} >
                              <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                                ...
                                <View><Text allowFontScaling={false} adjustsFontSizeToFit={false} style={{color:'#4D4D4D',fontSize:WID==320 ? 14 : 16,}}>默认地址</Text></View>
                              </View>
                          </TouchableOpacity>
